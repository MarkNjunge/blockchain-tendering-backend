...
```JSON
{
  ...
  "requiredDocuments": [
    {
      "$class": "com.marknjunge.tendering.tender.ExtraDocument",
      "key": "BID_BOND",
      "document": {
        "$class": "com.marknjunge.tendering.tender.Document",
        "documentRef": "Nostrud nisi excepteur.",
        "documentHash": "Dolore mollit ut.",
        "datePosted": "2019-09-24T07:31:14.172Z"
      }
    },
    {
      "$class": "com.marknjunge.tendering.tender.ExtraDocument",
